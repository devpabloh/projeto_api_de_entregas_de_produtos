...
-- CreateEnum
CREATE TYPE "DeliveryStatus" AS ENUM ('processing', 'shipped', 'delivered', 'returned');
...
CREATE TABLE "users" (
    ...
    "name" TEXT NOT NULL,
    "email" TEXT NOT NULL,
    "password" "UserRole" NOT NULL DEFAULT 'customer',
    "role" TEXT NOT NULL,
    "_created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
